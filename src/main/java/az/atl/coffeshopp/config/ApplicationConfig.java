package az.atl.coffeshopp.config;
...
public class ApplicationConfig {
    ...
    public UserDetailsService userDetailsService() {
        return phoneNumber -> userRepo.getUserEntityByPhoneNumber(phoneNumber).orElseThrow(() -> new UsernameNotFoundException("Username not found"));
    }
